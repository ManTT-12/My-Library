...
<body class="d-flex justify-content-center align-items-center" style="height: 100vh;">
    <form action="./xulyDN.php" method="post" id="form" class="border-black">
        <div class="form-content m-3 p-lg-3">
            ...
            <div class="my-2">
                <button type="submit" name="dangnhap" class="signin-btn w-100 rounded">Đăng nhập</button>
            </div>
            <div class="w-100 d-flex my-2 text-center">
                <button type="button" class="home-btn w-100 rounded" style="margin-right: 0.2rem;"><a href="../index.php">Trang chủ</a></button>
                <button type="button" class="signup-btn w-100 rounded"><a href="../DangKy/dangky.php">Đăng ký</a></button>
            </div>
        </div>
    </form>
</body>
