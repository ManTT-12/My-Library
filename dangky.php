...
<body class="h-screen">
    <div class=" h-full flex justify-center items-center">
        <form action="" method="post" class="border border-black rounded bg-sky-700/60">
            <div class="p-4">
                <div class="text-center p-3 text-white">
                    <h1 class="font-bold capitalize text-2xl font-serif">My Library</h1>
                    <h3 class="font-bold capitalize text-xl">Đăng ký</h3>
                </div>
                <div class="mb-4">
                    <div class="mb-2">
                ...
                <div class="btn-signup">
                    <button type="submit" class="w-full rounded border border-slate-200 bg-sky-700/60 hover:bg-sky-700/70 text-slate-200">Đăng ký</button>
                </div>
                <div class="other-btn mt-2 flex justify-center items-center space-x-1.5">
                    ...
                    <button type="button" class="w-full rounded border border-slate-200 bg-rose-300 text-slate-200"><a href="./dangnhap.php">Đăng nhập</a></button>
                </div>
            </div>
        </form>
    </div>
